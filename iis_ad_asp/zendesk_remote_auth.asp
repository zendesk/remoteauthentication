<%
    ...
    '
    ' Please refer to http://www.zendesk.com/api/remote_authentication for an in depth explanation on how
    ...
    ' Token and URL from the integrations page on your Zendesk account
    sToken     = ""
    sReturnURL = ""
        
    sNoLogin = "Couldn't login to Zendesk. Please contact your administrator"
    
    '
    ' MOST LIKELY, YOU SHOULD NOT CHANGE ANYTHING BELOW HERE. IF YOU'RE INTO EXTERNAL ID'S YOU SHOULD.
    '
    ...
    If Not userRS.EOF and not err then
        ...
        if sEmail > "" then
            sMessage = sFullName & sEmail & sExternalID & sToken & Request.QueryString("timestamp")
            ...
            sURL = sReturnURL & _
                ...
                "&external_id=" & sExternalID & _
                "&timestamp=" & Request.QueryString("timestamp") & _
                "&hash=" & sDigest
